...
jboolean Java_net_kismetwireless_android_pcapcapture_PcapLogger_openPcap(JNIEnv *env, jobject this, jstring file, 
																		unsigned int dlt) {
...
void Java_net_kismetwireless_android_pcapcapture_PcapLogger_closePcap(JNIEnv *env, jobject this) {
	jfieldID pcap_state_field;
...
jboolean Java_net_kismetwireless_android_pcapcapture_PcapLogger_logPacket(JNIEnv *env, jobject this,
																	  jobject packet) {
